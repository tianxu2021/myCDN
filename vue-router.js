...
;(t = this),
  (e = function () {
        ...
        : !!e &&
            (t.path && e.path
              ? t.path.replace(c, '') === e.path.replace(c, '') &&
                (r || (t.hash === e.hash && y(t.query, e.query)))
              : !(!t.name || !e.name) &&
                t.name === e.name &&
                (r ||
                  (t.hash === e.hash &&
      ...
      render: function (e, r) {
        ...
        if (((a.routerViewDepth = f), h)) {
          var d = p[u],
            v = d && d.component
          return v
            ? (d.configProps && w(v, a, d.route, d.configProps), s(v, a, o))
            : s()
        }
        var y = c.matched[f],
          g = y && y.components[u]
        ...
        return (
          b && (t(p[u], { route: c, configProps: b }), w(g, a, c, b)),
          s(g, a, o)
        )
      },
    }
    ...
    function S(t, e) {
      for (var r = new Array(t.length), n = 0; n < t.length; n++)
        'object' == typeof t[n] &&
          (r[n] = new RegExp('^(?:' + t[n].pattern + ')$', q(e)))
      return function (e, n) {
        for (
          var o = '',
            i = e || {},
            a = (n || {}).pretty ? T : encodeURIComponent,
            s = 0;
          s < t.length;
          s++
        ) {
    ...
    function V(e, r, n, o) {
      ...
      return (
        v && '#' !== v.charAt(0) && (v = '#' + v),
        { _normalized: !0, path: l, query: d, hash: v }
      )
    }
    var H,
      N = function () {},
      F = {
        ...
        render: function (e) {
          ...
          if ('a' === this.tag)
            (k.on = R), (k.attrs = { href: u, 'aria-current': b })
          else {
            var C = (function t(e) {
              var r
              if (e)
      ...
      function s(t, r) {
        ...
        return (
          ...
          c
            ? (i[c],
              a(
                { _normalized: !0, name: c, query: h, hash: l, params: d },
                void 0,
                r
              ))
            : f
    ...
    function X(t, e, r) {
      ...
      for (var o = 1, a = n.length; o < a; ++o) {
        var s = t.keys[o - 1]
        s &&
          (r[s.name || 'pathMatch'] = 'string' == typeof n[o] ? i(n[o]) : n[o])
      }
      return !0
    }
    var Y =
    ...
    function rt() {
      ...
      return (
        ...
        window.addEventListener('popstate', it),
        function () {
          ...
          if ('function' == typeof t && void 0 === t.cid) {
            ...
            var u,
              c = Ot(function (e) {
                var o
                ;((o = e).__esModule ||
                  (At && 'Module' === o[Symbol.toStringTag])) &&
                  (e = e.default),
    ...
    return (
      ...
      (Vt.version = '3.5.2'),
      (Vt.isNavigationFailure = Rt),
      (Vt.NavigationFailureType = yt),
      (Vt.START_LOCATION = h),
      D && window.Vue && window.Vue.use(Vt),
      Vt
    )
  }),
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(e)
    : ((t =
        'undefined' != typeof globalThis ? globalThis : t || self).VueRouter =
        e())
